...
<table width="1019" border="1">
  <tr>
    <td width="134"><b><font color="red">Câu: &nbsp;<?php // echo ++$stt; 
		echo $sttallcau;
...
<input type="text"  name="<?php echo "txtdiemcau".$sttallcau;  ?>" id="<?php echo "txtdiemcau".$sttallcau; ?>" value="<?php echo round($diemct/$socau_ct,3)." điểm" ?>" size="5"  />
    ...
    <td width="766"><font class="tieude"><?php echo $tde   ?></font><br />
      <?php echo $mta; ?>
    </td>
    <td width="97"><a href='../SoanCauHoi/suacauhoi_gv.php?mcsua=<?php  echo $macau.'&&mlsua='.$ml.'&&mnsua='.$mn?>'>
...
<table width="1025" border="1">
  ...
  <tr>
    ...
    <td><font class="tieude"><?php echo $kqcautl['traloi']; ?></font></td>
    </tr>
</table>	
<?php	
}//while  tl
...
<table width="1027" border="1" class="subtable">
  <tr>
    <td width="159"><font color="#009999"><b>Câu:
        <?php  //echo $stt.'.'.++$stt2;
		echo $sttallcau.".".$stt2;
		  ?>
    ...
    <td width="852"><font class="tieude"><?php echo $kqcau_mt['noidung']   ?></font><br /></td>
    </tr>
  <?php
     $stt3="A";
...
<hr color="#FF0000" />
<center>
<input type="button" value="IN" class="command_print"  onclick="javascript:window.print();"/> <input type="button" value="Quay lại" class="command_back"  onclick="javascript:window.location='danhsachdethi_gvxem.php';"/>
</center>

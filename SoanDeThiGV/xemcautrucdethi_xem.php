...
<h2><font color="#0066FF">CHI TIẾT CÂU HỎI CỦA ĐỀ THI</font></h2>
...
$qrdethi=mysql_query("select dethi.madethi,tendethi,mamon,magv from dethi,cautrucde where dethi.madethi=cautrucde.madethi and magv='$magv'  group by dethi.madethi");
...
//hien thi ten ky thi
$qrview=mysql_query("select tendethi,mamon from cautrucde,dethi where   mamon='$mm' and dethi.madethi='$made' and dethi.madethi=cautrucde.madethi order by round(mid(macautrucde,instr(macautrucde,'-')+1,5),0)  desc ");
...
?>
<p></p>
<table width="1314" height="53" border="1"  id="tb2" class="tablelist">
  <thead>
    <th width="94"><div align="center"><strong>Mã cấu trúc</strong></div></th>
    <th width="178"><div align="center"><strong>Tên cấu trúc</strong></div></th>
    <th width="298"><div align="center"><strong>Tên nhóm</strong></div></th>
    <th width="134"><div align="center"><strong>Tổng số câu</strong></div></th>
    <th width="128"><div align="center"><strong>Tổng điểm</strong></div></th>
    <th width="167"><div align="center"><strong>Câu hỏi</strong></div></th>
    <th width="153"><div align="center"><strong>Chi tiết</strong></div></th>
</thead>
   <?php
   $stt=0;
   $tongsc=0;
...
; 
$sc= $sctong-$scco;
if($sc != 0) echo"<font color=red size=-1>Thiếu $sc câu</font>"; ?></td>

...
window.open("danhsachcauhoi.php",myObject,'fullscreen,scrollbars');
	 ...
	 window.open("danhsachcauhoi.php",myObject, "center:yes;dialogWidth:900px;dialogHeight:600px;status:no;dialogLeft:350px;dialogTop:250px;edge:raised");
...
echo "-Nhóm câu:<font color=blue> ".get_a_field('manhom',$_SESSION['nhom'],'nhom','1')."</font><br>";
 ...
 <input type="button"   id="btnhuy" onclick="javascript:window.location='xemcautrucdethi2.php'" value="Quay lại" class="command_back" />&nbsp; &nbsp; &nbsp;
...
//window.location='xemcautrucdethi2.php';
</script>
<?php
}
...
$qr=mysql_query("select * from cauhoi,chitiet_cauhoi_cautruc,cautrucde where   cautrucde.macautrucde='$mact' and chitiet_cauhoi_cautruc.macau=cauhoi.macau and chitiet_cauhoi_cautruc.macautrucde=cautrucde.macautrucde order by round(right(cauhoi.macau,4),0)  asc ");
?>
...
<table width="1101" border="1" id="tb2" class="tablelist">
  <thead>
    <tr>
      <th width="59">STT</th>
      <th width="135"><strong>Mã câu</strong></th>
    <th width="655"><strong>Tiêu đề</strong></th>
    <th width="115"><strong>Loại câu</strong></th>
    <th width="103"><input type="submit" value=" Xóa " name="btnxoa" class="command_del"/></th>
  </thead>
  <?php
  $stt=1;

...
<h2><font color="#0066FF">DANH SÁCH CÁC ĐỀ THI</font></h2>
<hr color="#0033CC" />
<?php
error_reporting(0);
//xoa du lieu
...
<div class="srolltable">
<table width="1441" height="88" border="1"  id="tb2" class="tablelist">
  <thead>
    <tr>
    <th width="94"><div align="center"><strong>Mã đề</strong></div></th>
    <th width="293"><div align="center"><strong>Tên đề thi</strong></div></th>
    <th width="247"><div align="center"><strong>Kỳ thi</strong></div></th>
    <th width="130"><div align="center"><strong>Tên môn</strong></div></th>
    <th width="140"><div align="center"><strong>Người soạn</strong></div></th>
    <th width="89"><div align="center"><strong>Ngạch</strong></div></th>
    <th width="86"><div align="center"><strong>Thời gian</strong></div></th>
    <th width="108"><div align="center"><strong>Tổng số câu</strong></div></th>
    <th width="91"><div align="center"><strong>Trạng thái</strong></div></th>
	...
	if($kq['trangthai']==1) {
	echo "Hiển thị, ";
	echo "<a href='onoff.php?tt=0&md=".$kq['madethi']."'><font color='red'>Tắt</font></a>";
	}
	 else{
	 echo "Ẩn, "; 
	 echo "<a href='onoff.php?tt=1&md=".$kq['madethi']."'><font color='red'>Mở</font></a>";
	 }?></td>
